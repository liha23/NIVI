      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {prompts.map((prompt, index) => (
          <button
            ...
            className="group relative p-4 bg-neutral-900/50 hover:bg-neutral-800/70 border border-neutral-800 hover:border-neutral-700 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-glow text-left overflow-hidden"
          ...
          >
            ...
            {/* Icon */}
            <div className={`relative w-12 h-12 rounded-xl bg-gradient-to-br ${prompt.color} flex items-center justify-center mb-3 shadow-medium group-hover:shadow-glow transition-shadow duration-300`}>
              <prompt.icon className="w-6 h-6 text-white" />
            </div>
            
            {/* Content */}
            <div className="relative">
              <h3 className="font-semibold text-neutral-200 mb-1 group-hover:text-white transition-colors">
                {prompt.title}
              </h3>
